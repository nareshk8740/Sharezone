    ...
    <div className='relative py-4 px-6 md:px-8 bg-white'>
      <div className='flex flex-col md:flex-row items-start gap-6'>
        ...
        <div className='w-32 h-32 border-4 border-white shadow-lg absolute -top-16 rounded-full overflow-hidden'>
          <img className='w-full h-full object-cover rounded-full' src={user.profile_picture} alt='Profile' />
        </div>
          ...
          <div className='flex flex-col md:flex-row items-start justify-between'>
            ...
            {!profileId && (
              <button
                ...
                className='flex cursor-pointer items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors mt-4 md:mt-0'
              >
